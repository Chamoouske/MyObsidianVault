...
name: Genjitsu no Yohane_ Sunshine in the Mirror
...
## [Wallpapers](https://wall.alphacoders.com/search.php?search=Genjitsu+no+Yohane:+Sunshine+in+the+Mirror&lang=Portuguese)
...
async function defer(key, value, file){
	...
	if((key === 'dropped' && value) || (key === 'finished' && value)){
		...
		await move(`Animes/TemporadaAtual/Genjitsu no Yohane_ Sunshine in the Mirror`, {...dv.current().file, extension: 'md'})
	}
}
